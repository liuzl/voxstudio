...
This directory holds reproducible research records and their registry. Product
behavior and architecture remain in `docs/`; private operational state remains
in the internal operations repository.

The governing taxonomy is
[`docs/research-taxonomy.md`](../docs/research-taxonomy.md). Do not create a
new research domain merely because a new package, model, vendor, or engine was
added.

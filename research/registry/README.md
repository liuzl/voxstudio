...
| VoxCPM2 through audio.cpp | E3 | not-promoted | Measured RTF 1.46 in the evaluated Metal path versus VoxStudio's faster existing VoxCPM2 configurations. No engine change followed. | [`voice-agent-roadmap.md`](../../docs/voice-agent-roadmap.md) |
